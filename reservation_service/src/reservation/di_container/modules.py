...
from src.reservation.api import (ReservationCancelResource,
                                 ReservationResource, ReservationsResource)
from src.reservation.domain.commands import (CancelReservationCommand,
...
from src.reservation.domain.queries import (GetReservationQuery,
